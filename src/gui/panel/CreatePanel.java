...
public class CreatePanel extends JPanel{
	...
	public CreatePanel() {
		...
		JLabel lblQuality = new JLabel("Æ·ÖÊ£º");
		...
		comboBoxQuality.setModel(new DefaultComboBoxModel(new String[] {"À¶¼°ÒÔÉÏ","ºì¼°ÒÔÉÏ","À¶","ºì","×Ï"}));
		...
		comboBoxPart.setModel(new DefaultComboBoxModel(new String[] {"Ëæ»ú","ÎäÆ÷","ÏîÁ´","ÊÖïí","½äÖ¸","Í·²¿","ÉÏÒÂ","Íó²¿","ÊÖÌ×","Ñü´ø","Ð¬×Ó",}));
		
		JLabel lblLevel = new JLabel("µÈ¼¶£º");
		...
		comboBoxSect.setModel(new DefaultComboBoxModel(new String[] {"Ëæ»ú","ÑªºÓ","ÌúÒÂ","ÉñÏà","¾ÅÁé","ËØÎÊ","ËéÃÎ"}));
